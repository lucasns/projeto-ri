...
class Classifier(object):
    def __init__(self):
        ...
        self._vocabulary, self._vocabulary_vectors = create_bag_of_words(self._X) # Creates Bag of Words model
        self._features_train, self._features_test, self._labels_train, self._labels_test = split_dataset(self._vocabulary_vectors, self._Y)
